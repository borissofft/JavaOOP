...
public class ControllerImpl implements Controller {
    ...
    public String sumOfAll(String houseName) {
        House house = getHouseByName(houseName, this.houses);
        double sumCatsPrices = house.getCats().stream().mapToDouble(Cat::getPrice).sum();
        double sumToysPrices = house.getToys().stream().mapToDouble(Toy::getPrice).sum();
        double valueOfTheHouse = sumCatsPrices + sumToysPrices;
        return String.format(ConstantMessages.VALUE_HOUSE, houseName, valueOfTheHouse);
    }
    ...
    private House getHouseByName(String houseName, Collection<House> houses) {
        return this.houses
                .stream()
