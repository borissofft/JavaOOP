...
public abstract class BaseProduct implements Product {
    ...
    public String toString() {
        return String.format("Overall Performance: %.2f. Price: %.2f - %s: %s %s (Id: %d)"
                , this.getOverallPerformance(), this.getPrice(), this.getClass().getSimpleName(), this.manufacturer, this.model, this.id); // Mnogo vajno e tuk da viknem stoinostite prez setyrite
        // zashtoto imame @Override v BaseComputer i tam neshtata se smqtat po syvsem drug nachin!!!!
    }
