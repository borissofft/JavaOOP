...
public class T04ValidateAddInstrumentToHelperMethod {
    ...
    public void validateAddInstrumentToDwarf() {
        ...
        String expectedMessage = String.format("Successfully added instrument with power %d to helper %s!", methodArgs[1], methodArgs[0]);
