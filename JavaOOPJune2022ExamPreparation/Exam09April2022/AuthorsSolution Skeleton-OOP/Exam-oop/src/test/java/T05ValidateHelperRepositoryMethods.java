...
public class T05ValidateHelperRepositoryMethods {
    ...
    public void validateClassMethods() {
        Class clazz = getType("HelperRepository");

        ExpMethod[] methods = new ExpMethod[]{
                new ExpMethod(Collection.class, "getModels"),
                new ExpMethod(void.class, "add", getType("Helper")),
                new ExpMethod(boolean.class, "remove", getType("Helper")),
                new ExpMethod(getType("Helper"), "findByName", String.class),
