...
public class T11ValidateCraftNoHelperReadyExMethod {
    ...
    public void validateCraftPresentNoDwarf() throws Throwable {
        ...
        getMethodValue(this.classType, this.classObject, "addHelper", new Object[]{"Sleepy", "Pesho"}, String.class, String.class);
